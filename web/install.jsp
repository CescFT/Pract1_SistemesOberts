    ...
    <body>
        ...
        <%
            ...
            String dataLlogater[] = new String[]{
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',69,0,'Pere','HOME',0)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES)  VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',69,0,'Pere','HOME',0)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',69,0,'Pere','HOME',0)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',60,0,'Marta','DONA',1)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',60,0,'Marta','DONA',1)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',60,0,'Marta','DONA',1)",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,EDAT_LLOGATER,FUMADOR,NOM_LLOGATER,SEXE,TEMASCOTES) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Cognom1',30,0,'Lloga la Habitacio','DONA',1)",              
            };
            ...
            String dataHabitacions[] = new String[]{
                ...
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO,PREU_MES,TIPUS, FUMADOR,MASCOTES, RANGEDATMAX,RANGEDATMIN,SEXE,LLOGATER_ID) VALUES (NEXT VALUE FOR HABITACIO_GEN, 'C/Major 72','Montferri','descripcio habitacio 2',500.10,'SIMPLE',0,1,60,30,'HOME',"+idsLlogaters.get(1)+")",
