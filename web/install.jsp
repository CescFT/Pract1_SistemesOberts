    ...
    <body>
        ...
        <%
            ...
            String dataLlogater[] = new String[]{
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER)  VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',1,0,'Marta')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',1,0,'Marta')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR LLOGATER_GEN,'Fernandez',1,0,'Marta')",              
            };
