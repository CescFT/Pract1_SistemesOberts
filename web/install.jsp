    ...
    <body>
        ...
        <%
            ...
            String dataLlogater[] = new String[]{
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR COMMENT_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER)  VALUES (NEXT VALUE FOR COMMENT_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR COMMENT_GEN,'Casanova',0,1,'Pere')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR COMMENT_GEN,'Fernandez',1,0,'Marta')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR COMMENT_GEN,'Fernandez',1,0,'Marta')",
                "INSERT INTO " + schema + ".LLOGATER (ID, COGNOM_LLOGATER,DONA,HOME,NOM_LLOGATER) VALUES (NEXT VALUE FOR COMMENT_GEN,'Fernandez',1,0,'Marta')",              
            };
            ...
            String dataHabitacions[] = new String[]{
                ...
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN,'C/Mossen martí 33 3r 3a', 'Valls','descripcio habitacio 1',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(0)+")", 
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN, 'C/Major 72','Montferri','descripcio habitacio 2',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(1)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN, 'Avda. Paisos Catalans 12', 'Reus', 'descripcio habitacio 3',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(2)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN, 'Rambla nova 5', 'Tarragona','descripcio habitacio 4',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(3)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN, 'C/Rafael de Casanova', 'Valls','descripcio habitacio 5',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(4)+")",
                "INSERT INTO " + schema + ".HABITACIO (HABITACIO_ID, ADREÇA, CIUTAT, DESCRIPCIO, DOBLE,EXTERIOR,INTERIOR,MOBLADA,PREU_MES, SIMPLE,DONA, FUMADOR,HOME, MASCOTES, RANGEDATMAX,RANGEDATMIN,UNISEX,LLOGATER_ID) VALUES (NEXT VALUE FOR COMMENT_GEN, 'Avda. Catalunya 2', 'Vallmoll','descripcio habitacio 6',0,0,0,0,500.10,1,0,0,0,1,30,50,1,"+idsLlogaters.get(5)+")"  
